    ...
    return (
        <section id="contact">
            <div>
                <form
                    name="contact"
                    className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-5 mt-5 md:mt-0"
                >
            ...
            suscipit officia aspernatur veritatis. Asperiores, aliquid?
              ...
              Name
                        ...
                        <input
                            ...
                            id="name"
                            name="name"
                            className="w-full bg-gray-800 rounded border border-black-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                        />
                    </div>
                    <div className="relative mb-4">
